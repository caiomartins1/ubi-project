...
class Content(models.Model):
    ...
    image_02 = models.ImageField(null=True, upload_to=content_image_file_path, blank=True)
    image_03 = models.ImageField(null=True, upload_to=content_image_file_path, blank=True)
